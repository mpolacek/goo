...
The C++17 proposal [P0522R0](https://wg21.link/p0522), *Matching of template template-arguments excludes compatible templates* which fixed [DR 150](https://wg21.link/cwg150) was implemented in GCC 7, but the new behavior was off by default.  Since GCC 11 defaults to C++17, the new behavior is enabled by default.
...
### Summary
I hope these notes will be useful for people migrating to GCC 11.  As with every major release, we've added new warnings which might turn up when switching compilers.  Should you find a bug in these new warning, please don't hesitate to open a new problem report as outlined [here](https://gcc.gnu.org/bugs/).
